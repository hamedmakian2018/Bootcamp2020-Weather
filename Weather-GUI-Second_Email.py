...
from emailing import email_function

#from App-gui-pop-sameP import get_weather
...
def get_weather(arg=None):
    ...
    def email():
        ...
        email_function(city_text, destotal)
    ...
    try :
        ...
        user_lb =Label(app, text='Do you want this information in you email', font=('bold',20))
        user_lb.place(x=120,y=560)

        user_lb =Label(app, text='Please enter your email', font=('bold',10))
        user_lb.place(x=30,y=630)
        
        
        email_entry = Entry (app, width=25, font=('bold',20))
        email_entry.focus()
        email_entry.bind("<Button-1>",email)
        email_entry.place(x=200,y=620)
        ...
        send_btn = Button(app, text='Send ', width=10, font=('bold',10), command=email).place(x=270,y=660)
        cancel_btn = Button(app, text='Cancel ', width=10, font=('bold',10), command=app.destroy)
        cancel_btn.place(x=430,y=660)
